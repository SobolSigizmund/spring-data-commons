...
import org.springframework.data.domain.reactive.ReactivePagingAndSortingPublisher;
...
public interface ReactivePagingAndSortingRepository<T, ID extends Serializable> extends ReactiveCrudRepository<T, ID> {
	 ...
	 */
	@Override
	ReactivePagingAndSortingPublisher<T> findAll();
	 ...
	 */
	@Override
	ReactivePagingAndSortingPublisher<T> findAll(Iterable<ID> ids);
	 ...
	 */
	@Override
	ReactivePagingAndSortingPublisher<T> findAll(Publisher<ID> ids);
	 ...
	 */
	ReactivePagingAndSortingPublisher<T> findAll(Sort sort);
	 ...
	 */
	ReactivePage<T> findAll(Pageable pageable);
}
